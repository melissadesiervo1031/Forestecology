...
```{r weighted mean t tests total cover and OTV}
...
head(totalcover_longOTV)

totalOTV_1969<-subset(totalcover_longOTV, YEAR==1969)
totalOTV_2015<-subset(totalcover_longOTV, YEAR==2015)
...
```{r plot ordination with cover data}
...
```{r plot ordination with OTV data}
...
#par(mfrow=c(2,1))
cols<-c("gray30", "green4")
plot(ordOTV, type="n", cex.lab=1.5)
